...
let
  firefoxSrc = fetchurl {
    url = "https://ftp.mozilla.org/pub/firefox/releases/135.0/source/firefox-135.0.source.tar.xz";
    hash = "sha256-gn4SqWLvR1EQia9EmPZev0L6V8ox23kL/X6agg0WuWA=";
  };

  surferDownloads = stdenv.mkDerivation {
    name = "surfer-downloads";
    __noChroot = true;
    buildInputs = [ surfer git ];
    ...
    cp ${surferJSON} surfer.json
    surfer ci --brand alpha
  ...
  surferJSON = fetchurl {
    url = "https://raw.githubusercontent.com/zen-browser/desktop/refs/tags/1.7.6b/surfer.json";
    hash = "sha256-LN4Llqi8N5mBYB98Qejq6fgBZczy/enw+bDFD7o/3M4=";
  };
  ...
  surfer = buildNpmPackage {
    ...
    src = fetchFromGitHub {
      owner = "zen-browser";
      repo = "surfer";
      rev = "7e928eb3ccf62a898cebe5d85d878b5b208ccd00";
  ...
  firefox-l10n = fetchFromGitHub {
    owner = "mozilla-l10n";
    repo = "firefox-l10n";
    rev = "aa98a57738d8e8fb5dd0b242e9e83c876afde13f";
