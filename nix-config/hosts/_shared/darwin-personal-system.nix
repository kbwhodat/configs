...
# reference: https://daiderd.com/nix-darwin/manual/index.html#sec-options
  ...
  launchd.user.agents.docker = {
    serviceConfig.ProgramArguments = [ "/Users/katob/.config/nix-config/hosts/_shared/scripts/start_colima.sh" ];
...
#  };
  ...
  homebrew = {
    ...
    brews = [ "firefoxpwa" ];
    casks = [ "monarch" "mitmproxy" "tradingview" "sublime-text" "ipvanish-vpn" "flutter" "karabiner-elements" "google-chrome" "freetube" "hammerspoon" "gcloud-cli"];
  };
