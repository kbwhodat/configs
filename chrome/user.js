...
user_pref("broswer.cache.memory.enable", true);
user_pref("broswer.sessionstore.resume_from_crash", false);
...
user_pref("browser.newtabpage.activity-stream.improvesearch.topSiteSearchShortcuts.searchEngines", "kagi");
...
user_pref("browser.urlbar.placeholderName", "search for something man");
user_pref("browser.urlbar.placeholderName.private", "Kagi");
...
user_pref("floorp.browser.sidebae.is.displayed", 2);
...
user_pref("floorp.browser.tabs.verticaltab.enabled", true);
...
user_pref("identity.fxaccounts.account.device.name", "katob");
user_pref("layout.css.prefers-color-scheme.content-override", 0);
user_pref("media.autoplay.default", 1);
user_pref("network.http.http3.enabled", true);
user_pref("privacy.trackingprotection.enabled", true);
user_pref("privacy.trackingprotection.socialtracking.annotate.enabled", true);
user_pref("privacy.trackingprotection.socialtracking.enabled", true);
user_pref("reader.color_scheme", "auto");
user_pref("services.sync.declinedEngines", "addons,passwords,prefs");
